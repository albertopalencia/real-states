...
namespace RealState.Domain.DTO.Usuario
{
	...
	public class ConsultaUsuarioDto
	{
		...
		public static implicit operator ConsultaUsuarioDto(Usuarios usuario) => new ConsultaUsuarioDto
		{
			Id = usuario.Id,
		...
		/// <param name="usuario">The usuario.</param>
		/// <returns>The result of the conversion.</returns>
		public static implicit operator Usuarios(ConsultaUsuarioDto usuario) => new Usuarios
		{
			Id = usuario.Id,
			Apellidos = usuario.Apellidos,
			Usuario = usuario.Usuario,
